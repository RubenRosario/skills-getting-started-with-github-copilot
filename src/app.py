...
activities = {
    ...
    "Swimming Club": {
        "description": "Swimming lessons and competitive swim practice",
    ...
    "Math Olympiad": {
        ...
        "max_participants": 12,
        "participants": ["elena@mergington.edu", "david@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice debate skills and compete in tournaments",
